...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account, dogePrice }) => {
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'SHARK' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
